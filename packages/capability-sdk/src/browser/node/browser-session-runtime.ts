...
export function sessionTabGrouperExtensionPath(environment: BrowserRuntimeEnvironment = process.env) {
  ...
  const candidates = [
    ...
    path.resolve(moduleDirectory, '..', '..', '..', 'runtime', 'browser', 'session-tab-grouper-extension'),
    path.join(process.cwd(), 'capability-runtime', 'browser', 'session-tab-grouper-extension'),
    path.join(process.cwd(), 'packages', 'capability-sdk', 'runtime', 'browser', 'session-tab-grouper-extension'),
    path.join(process.cwd(), 'node_modules', '@cjfclonedeep', 'capability-sdk', 'runtime', 'browser', 'session-tab-grouper-extension'),
  ];
