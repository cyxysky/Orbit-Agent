...
npm install @webpilot/capability-data @webpilot/capability-sdk @webpilot/capability-host typeorm better-sqlite3
...
import { DataSource } from 'typeorm';
 import { createTypeOrmAgentDataSource, createTypeOrmDataCapability } from '@webpilot/capability-data/typeorm';
...
- `@webpilot/capability-data`
- `@webpilot/capability-data/typeorm`
- `@webpilot/capability-data/mcp`
- `@webpilot/capability-data/runtime-skill`
- `@webpilot/capability-data/settings`
