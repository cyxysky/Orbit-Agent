...
function streamIntegrationTest(request: Request, candidate: ResolvedExternalIntegration, timeout: number, selectedTarget?: Pick<ExternalIntegrationTestTarget, 'kind' | 'id'>) {
