...
const applicationRuntimeEnvDefinitions: RuntimeEnvDefinition[] = [
  ...
  { key: 'AI_CONTEXT_COMPRESSION_TARGET_RATIO', label: '压缩后建议比例', description: '相对于模型上下文窗口的目标比例，范围 0.01–0.99，目标始终低于触发阈值。优先保留当前请求与最新完整交互，实际结果可能略高于目标，但不会超过可用输入预算。', tab: 'runtime', defaultValue: '0.25', control: 'number', min: 0.01, max: 0.99, step: 0.01 },
